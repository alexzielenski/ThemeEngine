...
- (void)setZeroCodeBezelInformation:(id /*CDStruct_c0454aff*/)arg1 forKey:(const void *)arg2 withLength:(unsigned long long)arg3;
- (void)setZeroCodeGlyphInformation:(id /*CDStruct_c0454aff*/)arg1 forKey:(const void *)arg2 withLength:(unsigned long long)arg3;
- (void)_setZeroCodeInfo:(id /*CDStruct_c0454aff*/)arg1 forKey:(const void *)arg2 withLength:(unsigned long long)arg3 inTree:(const void *)arg4;
